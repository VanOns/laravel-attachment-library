...
it('uploads a file', function () {
    ...
    $file = UploadedFile::fake()->image(fake()->firstName() . '.jpg');
...
it('renames a file', function () {
    $attachmentManager = new AttachmentManager();
    $fileNameA = fake()->firstName() . '.jpg';
    $fileNameB = fake()->firstName();
...
it('has directories after creating them', function () {
    $attachmentManager = new AttachmentManager();
    $directoryNameA = fake()->firstName();
    $directoryNameB = fake()->firstName();
...
it('prevents a duplicate on file rename', function () {
    ...
    $fileB = UploadedFile::fake()->image(fake()->firstName() . '.jpg');
...
it('resets the file list when switching disks', function () {
    ...
    $attachmentManager->setDisk(fake()->firstName());
...
it('requires a parent directory', function () {
    $attachmentManager = new AttachmentManager();
    $path = fake()->firstName() . '/' . fake()->firstName();
